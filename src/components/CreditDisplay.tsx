    ...
    <>
      <div className="flex items-center space-x-3">
        <div className="flex items-center space-x-2 glass rounded-lg px-3 py-2">
          ...
          <div>
            <p className="text-xs text-white/60 leading-none">Credits</p>
        ...
        <button
          ...
          className="flex items-center space-x-1 text-white/70 hover:text-white transition-colors p-2 rounded-lg hover:bg-white/10"
        >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="glass rounded-lg p-4 border border-blue-400/30">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-white mb-1">Payment Options</h4>
              ...
              <div className="space-y-3">
                <button
                  onClick={openTwitter}
                  className="w-full glass-button text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2"
                >
